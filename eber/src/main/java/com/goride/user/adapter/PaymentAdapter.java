...
public class PaymentAdapter extends BaseAdapter {
    ...
    private final ArrayList<com.goride.user.models.datamodels.PaymentGateway> selectedPaymentList;
    private final LayoutInflater layoutInflater;
    private ViewHolder viewHolder;

    public PaymentAdapter(Context context, ArrayList<com.goride.user.models.datamodels.PaymentGateway> selectedPaymentList) {
