...
import com.goride.user.adapter.CardAdapter;
import com.goride.user.adapter.PaymentAdapter;
...
import com.goride.user.components.MyAppTitleFontTextView;
...
import com.goride.user.components.MyTitleFontTextView;
import com.goride.user.fragments.FeedbackFragment;
...
public class PaymentActivity extends BaseAppCompatActivity {
    ...
    private ArrayList<com.goride.user.models.datamodels.Card> cardList;
    private int selectedCardPosition = 0;
    private boolean isClickedOnDrawer;
    private com.goride.user.models.datamodels.Card selectedCard;
    private SwitchCompat switchWalletUsed;
    private Spinner spinnerPayment;
    private ArrayList<com.goride.user.models.datamodels.PaymentGateway> paymentGatewaysList;
                ...
                public void onResponse(Call<IsSuccessResponse> call, Response<IsSuccessResponse> response) {
                    if (parseContent.isSuccessful(response)) {
                        if (response.body().isSuccess()) {
                            for (com.goride.user.models.datamodels.Card card : cardList) {
