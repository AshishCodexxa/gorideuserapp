...
import com.goride.user.adapter.DrawerAdapter;
import com.goride.user.adapter.PlaceAutocompleteAdapter;
import com.goride.user.components.CustomDialogBigLabel;
import com.goride.user.components.CustomDialogEnable;
import com.goride.user.components.CustomTripDialog;
import com.goride.user.components.DialogSplitPayment;
import com.goride.user.components.TopSheet.TopSheetBehavior;
import com.goride.user.fragments.FeedbackFragment;
import com.goride.user.fragments.InvoiceFragment;
import com.goride.user.fragments.MapFragment;
import com.goride.user.fragments.TripFragment;
import com.goride.user.interfaces.ClickListener;
import com.goride.user.interfaces.RecyclerTouchListener;
...
import com.goride.user.payment.PayUsingPaymentGateway;
import com.goride.user.utils.AppLog;
import com.goride.user.utils.Const;
import com.goride.user.utils.LocationHelper;
import com.goride.user.utils.SocketHelper;
import com.goride.user.utils.SpacesItemDecoration;
